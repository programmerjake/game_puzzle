...
public:
    static const TextureAtlas Blank, Font8x8, Steel, PlatformScreenshot, MazeScreenshot, MazeWall1,
        MazeWall2, MazeWall3, MazeWall4, MazeFinish;
...
private:
    ...
    static constexpr std::size_t textureCount = 4;
