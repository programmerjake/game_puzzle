...
{
template <>
struct hash<programmerjake::game_puzzle::ColorF> final
{
    hash<float> floatHasher;
    std::size_t operator()(const programmerjake::game_puzzle::ColorF &v) const
    {
...
template <>
struct hash<programmerjake::game_puzzle::ColorI> final
{
    hash<std::uint8_t> uint8Hasher;
    std::size_t operator()(const programmerjake::game_puzzle::ColorI &v) const
    {
