...
{
template <typename T>
void swap(programmerjake::game_puzzle::reader_lock<T> &l,
          programmerjake::game_puzzle::reader_lock<T> &r) noexcept
{
    l.swap(r);
}

template <typename T>
void swap(programmerjake::game_puzzle::writer_lock<T> &l,
          programmerjake::game_puzzle::writer_lock<T> &r) noexcept
{
    l.swap(r);
}
}
