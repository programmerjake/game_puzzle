...
{
template <>
struct hash<programmerjake::game_puzzle::TextureCoord> final
{
    hash<float> floatHasher;
    std::size_t operator()(const programmerjake::game_puzzle::TextureCoord &v) const
    {
...
template <>
struct hash<programmerjake::game_puzzle::Vertex> final
{
    hash<programmerjake::game_puzzle::VectorF> vectorHasher;
    hash<programmerjake::game_puzzle::ColorF> colorHasher;
    hash<programmerjake::game_puzzle::TextureCoord> textureCoordHasher;
    std::size_t operator()(const programmerjake::game_puzzle::Vertex &v) const
    {
...
template <>
struct hash<programmerjake::game_puzzle::IndexedTriangle> final
{
    hash<programmerjake::game_puzzle::IndexedTriangle::IndexType> indexHasher;
    std::size_t operator()(const programmerjake::game_puzzle::IndexedTriangle &v) const
    {
...
template <>
struct hash<programmerjake::game_puzzle::Triangle> final
{
    hash<programmerjake::game_puzzle::Vertex> vertexHasher;
    std::size_t operator()(const programmerjake::game_puzzle::Triangle &v) const
    {
