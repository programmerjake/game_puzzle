 ...
 *
 */
#ifndef RENDER_SETTINGS_H_INCLUDED
#define RENDER_SETTINGS_H_INCLUDED
...
{
    bool useFancyLeaves = false;
};

extern RenderSettings globalRenderSettings;
}
}

#endif // RENDER_SETTINGS_H_INCLUDED
