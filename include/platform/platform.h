...
{
template <>
struct hash<programmerjake::game_puzzle::KeyboardKey>
{
private:
    typedef std::underlying_type<programmerjake::game_puzzle::KeyboardKey>::type int_type;
    hash<int_type> hasher;

public:
    size_t operator()(programmerjake::game_puzzle::KeyboardKey v) const
    {
...
template <>
struct hash<programmerjake::game_puzzle::KeyboardModifiers>
{
private:
    typedef std::underlying_type<programmerjake::game_puzzle::KeyboardModifiers>::type int_type;
    hash<int_type> hasher;

public:
    size_t operator()(programmerjake::game_puzzle::KeyboardModifiers v) const
    {
        return hasher(static_cast<int_type>(v));
    }
};
...
template <>
struct hash<programmerjake::game_puzzle::MouseButton>
{
private:
    typedef std::underlying_type<programmerjake::game_puzzle::MouseButton>::type int_type;
    hash<int_type> hasher;

public:
    size_t operator()(programmerjake::game_puzzle::MouseButton v) const
    {
        return hasher(static_cast<int_type>(v));
    }
};
